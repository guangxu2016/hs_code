<template>
	<view class="input_box">
		...
		<view class="header_top">
			<text>{{i18n.userCard}}:</text>
			<view>
				<radio @click="qiyeClick" :value="msg" checked="true" v-if="qiye" /><radio @click="qiyeClick" value="" v-else /><text>{{i18n.company}}</text>
			</view>
			<view>
				<radio @click="gerenClick" :value="msg" checked="true" v-if="geren" /><radio @click="gerenClick" value="" v-else /><text>{{i18n.personal}}</text>
			</view>
		</view>
		<view class="input"><input class="uni-input" v-model="username" :valueww="username" @input="messagesearch" type="text" :placeholder="i18n.pleaserRegNum" /></view>
		<view class="input yan">
			<input v-model="code" class="uni-input" :valueww="code" @input="codesearch" type="text" :placeholder="i18n.pleaseYanMa" />
		...
		<view class="input"><input class="uni-input" v-model="password" :valueww="password" @input="passwordsearch" type="password" :placeholder="i18n.pleasePassword" /></view>
		<view class="input"><input class="uni-input" v-model="repeat" :valueww="repeat" @input="repeatsearch" type="password" :placeholder="i18n.pleaseAgainPass" /></view>
		...
		<view @click="login" class="submit">{{i18n.register}}</view>
