<template>
	<view class="content">
		...
		<view class="content_box">
			...
			<view class="entry">
				<view><input class="uni-input" v-model="search" :valueww="search" @input="messagesearch" type="text" :placeholder="i18n.pleaseHScode" /></view>
				<view><input class="uni-input" v-model="searchs" :valueww="searchs" @input="messagesearchs" type="text" :placeholder="i18n.pleaseHScode" /></view>
			</view>
...
export default {
	...
	let country_one = uni.getStorageSync('country_one');
		let country_two = uni.getStorageSync('country_two');
