<template>
	<view class="box">
		...
		<!-- 购买单次查询 -->
		<view class="huiyuan">
			<view>{{i18n.dancichaxun}}</view>
			<view>
				<view @click="payTypeIdfour(0,1)" :class="{ checkedfour: isCheckFour == 0 }">
					<view>
						<text>1次</text>
						<text>2元</text>
						<view class="dui">
				...
				<view @click="payTypeIdfour(1,2)" :class="{ checkedfour: isCheckFour == 1 }">
					<view>
						<text>2次</text>
						<text>4元</text>
						<view class="dui">
				...
				<view @click="payTypeIdfour(2,3)" :class="{ checkedfour: isCheckFour == 2 }">
					<view>
						<text>3次</text>
						<text>6元</text>
						<view class="dui">
				...
				<view @click="payTypeIdfour(3,4)" :class="{ checkedfour: isCheckFour == 3 }">
					<view>
						<text>4次</text>
						<text>8元</text>
						<view class="dui">
...
<script>
	export default {
		...
		methods: {
			...
			payTypeIdfour(index,num){
				this.isCheck = -1;
				this.isCheckTwo = -1;
				this.isCheckthree = -1;
				this.isCheckFour = index;
				console.log(num);
						...
						success: res => {
							if (res.data.code == 200) {
								...
								if(alipy == 1){
									...
									let orderInfo = res.data.data.payData.payData;
									paysss = "alipay";
									uni.requestPayment({
										provider: paysss,
										orderInfo: orderInfo,
