								...
								success: function(loginRes) {
									...
									uni.getUserInfo({
										...
										success: function(infoRes) {
											...
											console.log(JSON.stringify(infoRes.userInfo.nickName));
										}
									});
								}
							});
...
<style>
	...
	.ren_zheng {
		...
		padding-top: 30rpx;
		width: 100%;
		/* background:url("../../static/image/rz.png"); */
		background-image: url("http://wangsw.aiquanyouxuan.vip/wx_bg.png");
		background-size: 100% 100%;
		overflow: hidden;
		box-sizing: border-box;
	}
